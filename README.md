# Visual Studio Tips and Keyboard Shortcuts
...
=================
   ...
   * [Table of Contents](#table-of-contents)
      ...
      * [Common issues](#common-issues)
         * [Resharper not working properly](#resharper-not-working-properly)
      ...
      * [General tips](#general-tips)
         * [Upgrading .NET version](#upgrading-net-version)
...
4. Go back into Tools --> Options --> Environment --> Keyboard
    * Assign *Window.CloseDocumentWindow* to Ctrl + W and remove the Ctrl + W shortcut for *Edit.SelectCurrentWord*.
    ...
    * Assign *Edit.MovesSelectedLinesUp* to Alt + Up arrow and *Edit.MovesSelectedLinesDown* to Alt + Down arrow
...
* Code navigation
    ...
    * Move line of code up/down **Alt + Up/Down arrow**
* Searching
